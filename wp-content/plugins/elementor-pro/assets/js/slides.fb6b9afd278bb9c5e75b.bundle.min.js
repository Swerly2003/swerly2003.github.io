            ...
            class SlidesHandler extends elementorModules.frontend.handlers.SwiperBase {
                ...
                async initSlider() {
                    ...
                    const i = this.getSettings(),
                        s = e.data(i.attributes.dataAnimation);
                    s && (this.swiper.on("slideChangeTransitionStart", (function() {
                        e.find(i.selectors.slideInnerContents).removeClass(i.classes.animated + " " + s).hide()
                    })), this.swiper.on("slideChangeTransitionEnd", (function() {
                        e.find(i.selectors.slideInnerContents).show().addClass(i.classes.animated + " " + s)
                    })))
                }
                onInit() {
